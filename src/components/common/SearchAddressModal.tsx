  ...
  return (
    <div className={'fixed inset-0 z-50 flex items-center justify-center bg-[rgba(0,0,0,0.3)]'}>
      <div
        ...
        className="desktop:h-[508px] desktop:w-[1008px] desktop:translate-x-[-50%] desktop:translate-y-[-50%] desktop:top-[50%] desktop:right-[50%] desktop:left-[50%] fixed flex flex-col gap-y-4 rounded-[32px] bg-white p-6"
      >
