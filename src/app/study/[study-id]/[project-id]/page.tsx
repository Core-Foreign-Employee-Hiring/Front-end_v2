  ...
  return (
    <main className="">
      ...
      <div className="mt-[32px] flex flex-col gap-y-[20px] px-5">
        ...
        <p className="body-md">
          KORI는 KOR’ea + 고‘리’의 의미를 담아 외국인 노동자의 안정적인 한국 생활과 정착을 돕는 플랫폼입니다. 앱을 통해
          맞춤형 안전·직무 교육을 제공하고, 학습 기록은 자동으로 포트폴리오(이수증)로 정리됩니다. 정부와 사업주에게는
          참여율 데이터를 제공하며, 학습자에게는 포인트와 인센티브를 통해 지속적인 학습을 유도합니다.
        </p>
